...
onagorodniuk-local@compute-0:/usr/share/diamond/collectors/memory$ G^C
onagorodniuk-local@compute-0:/usr/share/diamond/collectors/memory$ sudo service diamond restart^C
(failed reverse-i-search)`мшь': ^C
(failed reverse-i-search)`мшь': ^C
onagorodniuk-local@compute-0:/usr/share/diamond/collectors/memory$ ^C
onagorodniuk-local@compute-0:/usr/share/diamond/collectors/memory$ vim^C
onagorodniuk-local@compute-0:/usr/share/diamond/collectors/memory$ vim memory.py
onagorodniuk-local@compute-0:/usr/share/diamond/collectors/memory$ sudo service diamond restart
[sudo] password for onagorodniuk-local:
diamond stop/waiting
diamond start/running, process 21214
onagorodniuk-local@compute-0:/usr/share/diamond/collectors/memory$ vim memory.py
onagorodniuk-local@compute-0:/usr/share/diamond/collectors/memory$ cat memory.py
# coding=utf-8
